...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
  public static final int VIDEO_LAYOUT_ORIGIN = 0;//原始状态
  public static final int VIDEO_LAYOUT_SCALE = 1;//长边填充满屏幕,视频完整显示,允许留黑边
  public static final int VIDEO_LAYOUT_STRETCH = 2;//(伸开展开)全屏
  public static final int VIDEO_LAYOUT_ZOOM = 3;//直接放大，不要留黑边
  ...
  private int mVideoLayout = VIDEO_LAYOUT_SCALE;//(比例)默认为长边铺满
