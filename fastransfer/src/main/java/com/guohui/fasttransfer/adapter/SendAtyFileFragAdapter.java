...
import com.guohui.fasttransfer.utils.ImageLoader;
...
//                holder.ivFileImage.setImageBitmap(getVideoThumbnail(file.getPath(), 60, 60,MediaStore.Images.Thumbnails.MINI_KIND));
                holder.ivFileImage.setImageResource(R.drawable.video_default_icon);
                String url = file.getPath();
                holder.ivFileImage.setTag(url);
//                new ImageLoader().showImageByThread(holder.ivFileImage,url);
                mImageLoader.showImageByAsyncTask(holder.ivFileImage,url);
            }//
            //设置文件的大小//
